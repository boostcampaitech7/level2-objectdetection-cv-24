...
load_from = './mmdetection/work_dirs/codino_swin_real/best_coco_bbox_mAP_50_epoch_12.pth'
load_pipeline = [
...
train_pipeline = [
    dict(_scope_='mmdet', max_num_pasted=100, type='CopyPaste'),
...
work_dir = './mmdetection/work_dirs/codino_swin_real'
