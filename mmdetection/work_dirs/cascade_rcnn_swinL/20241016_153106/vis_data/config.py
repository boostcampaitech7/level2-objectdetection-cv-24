...
model = dict(
    backbone=dict(
        ...
        init_cfg=dict(
            checkpoint=
            'https://github.com/open-mmlab/mmdetection/releases/download/v2.0.0/cascade_mask_rcnn_swin_large_patch4_window7_224_22k_coco.pth',
            type='Pretrained'),
        mlp_ratio=4,
        num_heads=[
            6,
...
work_dir = './mmdetection/work_dirs/cascade_rcnn_swinL'
