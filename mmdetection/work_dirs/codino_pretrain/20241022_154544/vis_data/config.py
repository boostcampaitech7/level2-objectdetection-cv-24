...
default_hooks = dict(
    checkpoint=dict(
        by_epoch=True, interval=1, max_keep_ckpts=3, type='CheckpointHook'),
...
train_cfg = dict(
    _delete_=True, max_epochs=36, type='EpochBasedTrainLoop', val_interval=1)
...
work_dir = './mmdetection/work_dirs/codino_pretrain'
