...
model = dict(
    ...
    bbox_head=dict(
        ...
        prior_generator=dict(
            ...
            base_sizes=[[(72, 69), (162, 157), (356, 186)],
                        [(221, 319), (263, 543), (461, 376)],
                        [(731, 412), (484, 693), (865, 794)]],
            strides=[8, 16, 32]),
        bbox_coder=dict(
...
#         mode='min',  # 혹은 'max' - metric이 감소할 때 사용
#         factor=0.1,  # 감소율
#         patience=10,  # 성능이 개선되지 않을 때 대기할 에폭 수
#         verbose=True,
#         threshold=0.0001,  # 성능 개선을 감지할 최소 변화량
#         threshold_mode='rel',  # 상대적 변화
#         cooldown=0,  # 감소 후 대기 시간
#         min_lr=0,  # 최소 학습률
#         eps=1e-8  # 수치 안정성
#     )
# ]
